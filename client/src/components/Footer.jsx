        ...
        <div className='bg-[#0f172a] text-gray-300 py-16 px-5 md:px-20 border-t border-gray-800'>
            ...
            <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12'>
                ...
                <div>
                    ...
                    <ul className='space-y-3 text-gray-400'>
                        {/* REMOVED the extra <Link> </Link> inside these lines */}
                        ...
                        <li><Link to="/privacy-policy" className='hover:text-[#0D9488] transition-colors'>Privacy Policy</Link></li>
                        <li><Link to="/terms-conditions" className='hover:text-[#0D9488] transition-colors'>Terms & Conditions</Link></li>
                    </ul>
                </div>
